    ...
    return (
        ...
        >
            <div className="w-full md:px-3  px-12 flex justify-center  relative items-center ease-in noSelect">
                <span
                    className="w-full md:pr-8 ellipsis text-xl my-1 md:text-3xl md:my-0 box-border noSelect text-center font-medium   md:text-start">{title}</span>
                <div className="absolute w-full flex justify-end items-center ">

                    <div className="p-1 relative flex justify-center items-center scale-90 md:scale-100">
                        <TrashCan/>
                        <motion.div

    ...
    return (
        <div className="w-full h-full flex justify-center items-center font-mono mx-2 md:mx-6">
            <div
                ...
                <span className="text-main-4 text-lg sm:text-2xl">Warning!</span>
                <span
                    className="text-center text-main-4 text-sm sm:text-base">You are already logged into your account</span>

    ...
    return (
        <div
            ...
            <form
                ...
                <div className=" absolute right-0 top-0 mx-3 mt-3 cursor-pointer" onClick={handleCloseBoardCreateMenu}>
                    <CloseIcon className="w-8 h-8"/></div>
            ...
            <div className="w-screen h-screen absolute visible opacity-80 bg-main-1 z-0" onClick={handleCloseBoardCreateMenu}></div>
